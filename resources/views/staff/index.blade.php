...
<head>
    <title>Inventory Management System Staff Login</title>
                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block mt-2">
                                <img src="{{asset('images/staffback.jpg')}}" alt="login form" class="img-fluid"
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    @endif
                                    <form action="{{route('staff.login')}}" id="staffslogin" method="POST">
                                        @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Staff Register Form</h5>
                ...
                <div class="modal-body">
                    ...
                    @endif
                    <form action="{{route('staff.register')}}" id="registerStaff" method="POST">
                        @csrf
                        <div class="mb-3">
